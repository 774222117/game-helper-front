...
<script>
import gameItemBig from '@/components/NationalDay/gameItem/gameItemBig';//游戏大图
            ...
            if(!!_this.$store.getters.getStorage){
                switch (luckDrawNumModel) {
                    case 'congratulationsGame':
                        ...
                        if(_this.balanceCard.balance*1 < _this.payMoney*1 && _this.payMoney != 999){
