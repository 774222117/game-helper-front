    ...
    <div class="alertContent">
        ...
        <div class="middleContents">
            ...
            <div class="leftGameInfo">
                ...
                <!-- 游戏名字 -->
                <div class="gameNameInfo publicCenter">
                    <div class="gameNameLeft ft14 color_white_04">游戏名称</div>
                    <div class="gameNameRight ft14 color_white_08 textOver">游戏合玩包</div>
                </div>
                <!-- 游戏名字框 -->
                <div class="gameNames elevenActivityAllOrder_bg marB15 textOver ft12 color_white_06">
                    {{gamePackageName}}
                </div>
                <!-- 购买类型 -->
                <div class="purchaseType publicCenter marB15">
                    <div class="ft14 color_white_04">购买类型</div>
                    <div class="ft14 color_white_08">畅享版</div>
                </div>
                <!-- 分割线 -->
                <div class="divider marB15"></div>
                <!-- 选择优惠 -->
                <div class="chooseAdiscount marB15">
                     ...
                     <div class="chooseAdiscountBox">
                        ...
                        <div class="displayPrice">
                                ...
                                <div class="contents seckillOrder_bg">
                                    ...
                                    <div class="textContents">
                                        <div class="leftText"> 
                                            ...
                                            <div class="ft14 color_white_1 margin_left_20">限时礼包价</div>
                                        </div>
                            ...
                            <div class="ft10 color_white_04"></div>
                        </div>
                     </div>
                </div>
                <!-- 账户余额 -->
                <div class="accountBalance publicCenter marB15">
                    <div class="ft14 color_white_04">账户余额</div>
                    <div class="checkBox" v-if="ifUseBalance" @click="balancePaymentHook"> 
                        <div class="checkMark"><svg-icon v-if="isBalancePayment" iconClass="whiteHookUp" class="svg_icon"></svg-icon></div>
                        <div class="ft14 color_white_08">使用 ¥{{balance}}</div>
                    </div>
                    <div class="checkBox ft14 color_white_1" v-else> -- </div>
                </div>
                 <!-- 分割线 -->
                <div class="divider marB24"></div>
                <!-- 卖点 畅享版 -->
            ...
            <div class="rightPaymentInfo" v-if="enough == 2">
                <div class="balancePayment back5 ft14 color_white_1" @click="balancePayment" >
                    {{isCouponPurchase == false?'使用余额直接支付':'使用试玩券'}}</div>
            </div>
...
export default {
    ...
    data() {
        return {
            ...
            gamePackageName:'', //创建订单显示所有游戏的名字

            createeOrderData:{
                groupId: this.allOrderData.groupId,
    ...
    methods: {
        ...
        createOrder(){
            var _this = this;
            _this.$fetch("/module/activity/create", _this.createeOrderData).then(response => { 
                if(response.flag){
